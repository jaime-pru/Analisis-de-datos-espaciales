...
```{r message=FALSE, warning=FALSE, fig.alt= "Gráfico de dispersión que representa la relación entre los casos positivos (pos_hab) en el eje x y el número promedio de grados cursados (grad) en y. El gráfico muestra la mayor agrupación de dato por debajo de 10 en pos_hab y 12 en grad" }
library(tidyverse)
...
```{r message=FALSE, warning=FALSE, fig.alt=""}
ggplot2::ggplot(data=covid_zmvm)+
